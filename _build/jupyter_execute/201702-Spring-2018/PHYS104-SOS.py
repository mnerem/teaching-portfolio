...
essay=pd.read_excel('../../../Student-Opinion-Surveys/201703-PHYS104-SOS.xlsx',sheet_name='Essay-Responses')
...
sos_markdown=sos.to_markdown(index=False,tablefmt='grid')


# In[5]:


#for question in essay.columns:
#    print('**'+question+'**')
#    for response in essay[question]:
#        if str(response)!='nan':
#            print('* '+response)
